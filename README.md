...
* **مدیریت تعاملات هوش مصنوعی:** مسیر اصلی فعلی ارسال پیام از طریق BFF داخلی و قرارداد بک‌اند `/api/chat/send/` انجام می‌شود؛ کدهای OpenRouter/streaming برای سناریوهای دمو یا توسعه آینده حفظ شده‌اند.
