...
فعال‌سازی آزمایشی ورود با شماره، تفاوت محیط تست و انتشار، و blockerهای بک‌اند در [docs/PHONE_AUTH_V1.md](docs/PHONE_AUTH_V1.md) است. پیش‌فرض `PHONE_AUTH_ENABLED` خاموش است.
